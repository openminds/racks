...
(function(a){a.fn.fixHeaderFooter=function(){if(!a.support.scrollTop)return a(this);return a(this).each(function(){a(this).data("fullscreen")&&a(this).addClass("ui-page-fullscreen");a(this).find('.ui-header[]').addClass("ui-header-fixed ui-fixed-inline fade");a(this).find('.ui-footer[]').addClass("ui-footer-fixed ui-fixed-inline fade")})};a.fixedToolbars=function(){function e(i){var j=a(window).scrollTop(),l=i.offset().top,p=i.css("top")=="auto"?0:parseFloat(i.css("top")),
